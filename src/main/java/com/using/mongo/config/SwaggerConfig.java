...
/************
 * @info : Swagger UI Config
 * @name : SwaggerConfig
 * @date : 2023/03/22 2:13 AM
...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private static final String API_DESCRIPTION = "mongoDB Test Application";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title(SERVICE_NAME) // 서비스명
                ...
                .licenseUrl("https://github.com/swings134man/")
                .build();
